...
export class Swap {
    ...
    static swapContract = "roxeswaptest";//process.env.CONTRACT;
    static SWAP_CONTRACT = "roxearntoken";
    static ONE_DECIMALS = 9;
    static sym2dec: { [name: string]: any } = { "USD": 6, "BTC": 8, "ROC": 4 };
    static MAX_SUPPLY = "10000000000";
